                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: const Color(0xFF4ADE80)
                          .withValues(alpha: 0.4 + 0.6 * tickCtrl.value),
                    ),
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedOpacity(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white.withValues(alpha: 0.04 + (1 - opacity) * 0.01),
          borderRadius: BorderRadius.circular(12),
        ...
        child: Row(
          children: [
            ...
            Container(
              width: 44, height: 44,
              decoration: BoxDecoration(
                color: const Color(0xFF0A5C5C).withValues(alpha: opacity),
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Display unavailable',
              style: GoogleFonts.dmSans(
                  fontSize: 20, color: Colors.white.withValues(alpha: 0.6))),
